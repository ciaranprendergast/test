...
The representation below uses the shade of the county to show the relative number of cases present with regards to the population. The darker the shade, the greater the prevalence. Updated as of `r the.date`.
