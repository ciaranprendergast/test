...
We see here the total confirmed cases in the republic, reaching **`r data1$TotalConfirmedCovidCases[which(data1$Date == the.date)]`** on `r the.date`. The blue bars represent the percentage increase on total while the red line tracks total cases.
