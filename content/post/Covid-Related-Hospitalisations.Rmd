...
We see here the trend in hospitalisations on `r the.date`. The blue bars represent the percentage increase on total while the red line tracks total hospitalisations.
