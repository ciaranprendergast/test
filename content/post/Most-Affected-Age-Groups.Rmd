...
The graph below shows the rate of cases per million of the population for each age-range. The yellow line represents the mean rate while green line represents the mean rate for citizens older than 15 years old. Updated as of `r the.date`.
