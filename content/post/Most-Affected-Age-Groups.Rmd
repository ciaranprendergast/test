...
age <- c("<5","05-14","15-24","25-34","35-44","45-54","55-64","65-74", "75-84", "85+")


cases <- as.numeric(c(data1$cases_under_5[which(data1$date == the.date )],
...
total.cases15plus <- totalllcases[which(data1$date == the.date )] -  (data1$cases_under_5[which(data1$date == the.date )]+               data1$cases_5_14[which(data1$date == the.date )]) #this gave the total amount of cases 15 plus
