...
external_link: 
image:
  caption: Cases over in last 3 Weeks
  focal_point: Smart
summary: Cases by County last 3 Weeks.
tags:
- Demo
title: Cases by County last 3 Weeks.
---
...
#kept last 21 days
counties <- tibble(newcases[which(newcases$date >= the.date - 21 ), counties_start:counties_stop])
counties1 <- as.data.frame(counties)
N<- nrow(counties1)
#maybe no need to unlist : as.numeric(unlist(counties1))
counties1<- sapply(counties1,as.numeric)
counties2 <- counties1[N,] - counties1[N-20,]
